...
public interface RendezVousRepo extends JpaRepository<RendezVous, Long> {
    ...
    List<RendezVous> findRendezVousByPatient_Code(Long id);

    List<RendezVous> findRendezVousByDateHeureRendezVousAfter(LocalDateTime dateDebut);

    RendezVous findRendezVousByDateHeureRendezVousBetweenAndPatient_Code(LocalDateTime dateDebut, LocalDateTime dateFin, Long id);
}
